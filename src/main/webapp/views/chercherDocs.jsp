    ...
    <div class="row">
      <div class="content-wrap col-60 col-md-60">
        ...
        <div class="row justify-content-center">
          ...
          <% List<DocumentJ> l=(List<DocumentJ>)request.getAttribute("l"); %>
                ...
                <table class="table table-striped rounded-lg custom-table" style="background-color: white; border-radius: 20px;">
                  ...
                  <tbody>
                   ...
                   <% for (int i = 0; i < l.size(); i++) { %>
                    <tr>
                      <td><input type="text" name="file-name" class="form-control-plaintext" readonly value="<%= l.get(i).getFileName() %>"></td>
                      <td><input type="text" name="file-type" class="form-control-plaintext" readonly value="<%= l.get(i).getFileType() %>"></td>
                      <td><input type="text" name="file-size" class="form-control-plaintext" readonly value="<%= l.get(i).getFileSize() %>"></td>
                      <td><input type="text" name="file-user" class="form-control-plaintext" readonly value="<%= l.get(i).getFileUser() %>"></td>
                      <td><input type="text" name="file-description" class="form-control-plaintext" readonly value="<%= l.get(i).getFileDescp() %>"></td>
                      <td><input type="text" name="path" class="form-control-plaintext" readonly value="<%= l.get(i).getFilePath() %>"></td>
                      <td>
                        <form action="downloadDoc.do" method="get">
                          <input type="hidden" name="filePath" value="<%= l.get(i).getFilePath() %>">
